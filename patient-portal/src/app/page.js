    ...
    <div className="container mx-auto p-4 space-y-8">
      ...
      <Tabs defaultValue="profile" className="w-full">
        <TabsList className="grid w-full grid-cols-4">
          <TabsTrigger value="profile" onClick={setActiveTab}>
            Profile
          </TabsTrigger>
          <TabsTrigger value="story" onClick={setActiveTab}>
            Your Story
          </TabsTrigger>
          <TabsTrigger value="faq" onClick={setActiveTab}>
            FAQ
          </TabsTrigger>
          <TabsTrigger value="resources" onClick={setActiveTab}>
            Resources
          </TabsTrigger>
        </TabsList>
